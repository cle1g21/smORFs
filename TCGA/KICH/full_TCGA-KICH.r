...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/DESeq2results_KICH.txt", sep = "\t", row.names = TRUE)
...
res <- read.table("/lyceum/cle1g21/smORFs/TCGA/KICH/DESeq2results_KICH.txt", header = TRUE, row.names = 1, sep = "\t", stringsAsFactors = FALSE)
View(res)
...
write.table(res, "/lyceum/cle1g21/smORFs/TCGA/KICH/DESeq2results_KICH_filtered_variants.txt", sep = "\t", quote = FALSE, row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/KICH/nuORFs_matched_KICH.txt", sep = "\t", row.names = TRUE)
