...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/DESeq2results_HNSC.txt", sep = "\t", row.names = TRUE)
...
res <- read.table("/lyceum/cle1g21/smORFs/TCGA/HNSC/DESeq2results_HNSC.txt", header = TRUE, row.names = 1, sep = "\t", stringsAsFactors = FALSE)
View(res)
...
write.table(res, "/lyceum/cle1g21/smORFs/TCGA/HNSC/DESeq2results_HNSC_filtered_variants.txt", sep = "\t", quote = FALSE, row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/HNSC/nuORFs_matched_HNSC.txt", sep = "\t", row.names = TRUE)
