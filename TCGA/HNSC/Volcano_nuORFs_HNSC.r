...
res <- fread("/lyceum/cle1g21/smORFs/TCGA/HNSC/nuORFs_matched_HNSC.txt")
View(res)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/HNSC/volcano_nuORFs_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
