...
saveRDS(gene_labels, file = "/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/gene_labels.rds")

write.table(res_lncRNA, file = "/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/DEGS_lncRNAs_BLCA.csv", sep = "\t", row.names = TRUE)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/Figures/volcano_DEGS_only_lncRNA_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
