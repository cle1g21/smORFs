...
res <- read.table("/lyceum/cle1g21/smORFs/TCGA/BLCA/DESeq2results_BLCA.txt", header = TRUE, row.names = 1, sep = "\t", stringsAsFactors = FALSE)
View(res)
...
write.table(res, "/lyceum/cle1g21/smORFs/TCGA/BLCA/DESeq2results_BLCA_filtered_variants.txt", sep = "\t", quote = FALSE, row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/BLCA/nuORFs_matched_BLCA.txt", sep = "\t", row.names = TRUE)
