...
saveRDS(dds, file = paste0("/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/dds.rds"))
...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/DESeq2results_BLCA.txt", sep = "\t", row.names = TRUE)
...
res <- read.table("/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/DESeq2results_BLCA.txt", header = TRUE, row.names = 1, sep = "\t", stringsAsFactors = FALSE)
View(res)
...
write.table(res, "/lyceum/cle1g21/smORFs/TCGA/BLCA/BLCA/Outputs/DESeq2results_BLCA_filtered_variants.txt", sep = "\t", quote = FALSE, row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/nuORFs_matched_BLCA.txt", sep = "\t", row.names = TRUE)
...
# Save plot as PNG
png("/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/Figures/Plot_Counts/plot_count_top15_upregulated_1.png", width = 800, height = 600)
...
for (i in 1:length(top15_upreg_genes)) {
    ...
    file_name <- paste0("/lyceum/cle1g21/smORFs/TCGA/BLCA/Outputs/Figures/Plot_Counts/plot_count_", gene_symbol, ".png")
