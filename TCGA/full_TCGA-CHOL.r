...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/DESeq2results_CHOL.txt", sep = "\t", row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/nuORFs_matched_CHOL.txt", sep = "\t", row.names = TRUE)
