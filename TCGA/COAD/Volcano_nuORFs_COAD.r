...
res <- read.delim("/lyceum/cle1g21/smORFs/TCGA/COAD/Outputs/nuORFs_matched_COAD.txt")
View(res)
...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/COAD/Outputs/nuORFs_gene_symbols_BLCA.csv", sep = "\t", row.names = TRUE)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/COAD/Outputs/Figures/volcano_nuORFs_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
