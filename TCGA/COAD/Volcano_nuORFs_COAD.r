...
res <- fread("/lyceum/cle1g21/smORFs/TCGA/COAD/nuORFs_matched_COAD.txt")
View(res)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/COAD/volcano_nuORFs_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
