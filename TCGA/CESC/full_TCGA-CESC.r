...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/DESeq2results_CESC.txt", sep = "\t", row.names = TRUE)
...
res <- read.table("/lyceum/cle1g21/smORFs/TCGA/CESC/DESeq2results_CESC.txt", header = TRUE, row.names = 1, sep = "\t", stringsAsFactors = FALSE)
View(res)
...
write.table(res, "/lyceum/cle1g21/smORFs/TCGA/CESC/DESeq2results_CESC_filtered_variants.txt", sep = "\t", quote = FALSE, row.names = TRUE)
...
write.table(resOrdered_nuORFs, file = "/lyceum/cle1g21/smORFs/TCGA/CESC/nuORFs_matched_CESC.txt", sep = "\t", row.names = TRUE)
