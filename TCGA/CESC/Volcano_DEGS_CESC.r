...
res <- read.delim("/lyceum/cle1g21/smORFs/TCGA/CESC/DESeq2results_CESC_filtered_variants.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
View(res)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/CESC/volcano_DEGS_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
