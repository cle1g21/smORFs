...
res <- read.delim("/lyceum/cle1g21/smORFs/TCGA/GBM/DESeq2results_GBM_filtered_variants.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
View(res)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/GBM/volcano_DEGS_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
