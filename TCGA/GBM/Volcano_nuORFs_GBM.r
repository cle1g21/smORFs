...
# read in DESeq2 results for GBM dataset
res <- read.delim("/lyceum/cle1g21/smORFs/TCGA/GBM/Outputs/nuORFs_matched_GBM.txt")
View(res)
...
write.table(res, file = "/lyceum/cle1g21/smORFs/TCGA/GBM/Outputs/nuORFs_gene_symbols_GBM.csv", sep = "\t", row.names = TRUE)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/GBM/Outputs/Figures/volcano_nuORFs_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
