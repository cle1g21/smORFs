...
res <- fread("/lyceum/cle1g21/smORFs/TCGA/GBM/nuORFs_matched_GBM.txt")
View(res)
...
ggsave("/lyceum/cle1g21/smORFs/TCGA/GBM/volcano_nuORFs_1.png", plot = volcano, width = 8, height = 6, dpi = 300, bg = "white")
